(function() {
	...
	function Init(quadratic) {
		...
		style = {
			...
			point: { radius: 10, width: 4, color: "#CA0", fill: "rgba(200,200,200,0.5)", arc1: 0, arc2: 2 * Math.PI }
		}
	...
	function ShowCode() {
		if (code) {
			code.firstChild.nodeValue = 
				"p1: ("+ point.p1.x+ ", " + point.p1.y +") \n" +
				"p2: ("+ point.p2.x+ ", " + point.p2.y +") \n" +
				"cp1: ("+ point.cp1.x+ ", " + point.cp1.y +") \n" +
				"cp2: ("+ point.cp2.x+ ", " + point.cp2.y +") \n"
		}
	}
